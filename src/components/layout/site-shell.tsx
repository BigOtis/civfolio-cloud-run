  ...
  return (
    <div className="min-h-screen text-[var(--ink)]">
      <header
        className={
          minimal
            ? "pointer-events-none fixed inset-x-0 top-0 z-50 px-3 pt-3 sm:px-4"
      ...
      >
        <div
          className={
            minimal
              ? "pointer-events-auto mx-auto flex w-full max-w-7xl items-center justify-end gap-3 rounded-[24px] border border-[rgba(244,211,141,0.14)] bg-[rgba(12,10,9,0.58)] px-3 py-2.5 shadow-[0_18px_50px_rgba(0,0,0,0.28)] backdrop-blur-xl sm:justify-between sm:px-4 sm:py-3"
        ...
        >
          ...
          <nav
            className={
              minimal
                ? "flex flex-wrap items-center justify-end gap-2 text-[11px] uppercase tracking-[0.22em] text-[var(--muted)]"
          ...
          >
            {site.navigation.map((item) => (
              <Link
                ...
                className={
                  minimal
                    ? "rounded-full border border-white/10 bg-white/5 px-3 py-2 transition hover:border-[var(--accent)] hover:text-[var(--accent-strong)] sm:px-4"
            ...
            {projectLinks.map((item) => (
              <a
                ...
                className={
                  minimal
                    ? "rounded-full border border-[var(--accent)]/30 bg-[rgba(244,211,141,0.06)] px-3 py-2 text-[var(--accent-strong)] transition hover:border-[var(--accent)] hover:text-[var(--parchment)] sm:px-4"
      ...
      <main className={minimal ? "pt-[4.5rem]" : undefined}>{children}</main>
      {minimal ? null : (
